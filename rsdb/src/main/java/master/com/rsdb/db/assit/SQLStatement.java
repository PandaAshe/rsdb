...
import master.com.rsdb.db.assit.Querier.CursorParser;
import master.com.rsdb.db.model.ColumnsValue;
import master.com.rsdb.db.model.EntityTable;
import master.com.rsdb.db.model.MapInfo;
import master.com.rsdb.db.model.MapInfo.MapTable;
import master.com.rsdb.db.model.Property;
...
public class SQLStatement implements Serializable {
    ...
    public int execUpdateWithMapping(SQLiteDatabase db, Object entity, TableManager tableManager) throws IOException {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            ...
            rows = (int) mStatement.executeUpdateDelete();
        }
        realease();
        if (OrmLog.isPrint) {
    ...
    public int execDeleteWithMapping(final SQLiteDatabase db, Object entity, TableManager tableManager)
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            ...
            nums = (int) mStatement.executeUpdateDelete();
        }
        if (OrmLog.isPrint) {
